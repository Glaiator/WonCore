...
public abstract class SoldierItem extends ArmorItem {
	public SoldierItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends SoldierItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "woncore:textures/models/armor/soldier_layer_1.png";
		}
	}
