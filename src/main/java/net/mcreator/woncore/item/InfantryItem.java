...
public abstract class InfantryItem extends ArmorItem {
	public InfantryItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends InfantryItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "woncore:textures/models/armor/infantry_layer_1.png";
		}
	}
}
