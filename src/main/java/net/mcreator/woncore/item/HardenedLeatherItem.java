...
public abstract class HardenedLeatherItem extends ArmorItem {
	public HardenedLeatherItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends HardenedLeatherItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "woncore:textures/models/armor/hl__layer_1.png";
		}
	}
	...
	public static class Leggings extends HardenedLeatherItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "woncore:textures/models/armor/hl__layer_2.png";
		}
	}
