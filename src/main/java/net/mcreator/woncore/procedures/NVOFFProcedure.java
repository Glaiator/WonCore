...
public class NVOFFProcedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getItem() == WoncoreModItems.SOLID_SUIT_X_407_BOOTS.get()
				...
				&& (entity.getCapability(WoncoreModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WoncoreModVariables.PlayerVariables())).nightvisionoption == false) {
			armor = true;
		} else {
			armor = false;
		}
