...
import net.mcreator.woncore.procedures.NightVisionOnKeyPressedProcedure;
...
public class NightVisionMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			NightVisionOnKeyPressedProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		WoncoreMod.addNetworkMessage(NightVisionMessage.class, NightVisionMessage::buffer, NightVisionMessage::new, NightVisionMessage::handler);
	}
}
